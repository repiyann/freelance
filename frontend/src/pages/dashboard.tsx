...
function Dashboard() {
	...
	return (
		<>
			<NavbarUser />
			<section id="home">
				<div className="flex px-5 py-3 md:py-20 md:pt-5 md:pb-12 md:px-10 lg:px-[132px] bg-[#f2f2f2] dark:bg-[#282828] justify-center items-center">
					<div className="flex-col items-start w-full">
						<div className="bg-[#3333] p-32 rounded-lg"></div>
						<div className="py-5">
							<h3 className="text-lg font-semibold">Popular Services</h3>
							<div className="grid grid-cols-3 gap-2 pt-2 md:gap-10">
								{['Mobile Developer', 'Web Developer', 'Writer'].map((category, i) => (
									...
									>
										<div className="bg-[#3333] px-5 py-2 rounded-lg">
											<p className="flex items-center justify-center text-center text-sm min-h-[40px] md:min-h-0 md:text-base">{category}</p>
										</div>
									</div>
								))}
							</div>
							<div className="grid grid-cols-3 gap-2 pt-3 md:gap-10">
